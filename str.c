...
//********************************************************************************************************
	...
	static str_t substring(str_t str, int begin, int end);
	static str_t trim_string(str_t str, str_t chars_to_trim);
	static str_search_result_t find_first_needle(str_t haystack, str_t needle);
	static str_search_result_t find_last_needle(str_t haystack, str_t needle);
	static bool str_contains_char(str_t str, char c);
	static str_t pop_first_split(str_t* str_ptr, str_t delimiters);
	static str_t pop_last_split(str_t* str_ptr, str_t delimiters);
...
{
	return trim_string(str, chars_to_trim);
}
...
{
	return find_last_needle(haystack, needle);
}

str_t str_pop_first_split(str_t* str_ptr, str_t delimiters)
{
	return pop_first_split(str_ptr, delimiters);
}

str_t str_pop_last_split(str_t* str_ptr, str_t delimiters)
{
	return pop_last_split(str_ptr, delimiters);
}
